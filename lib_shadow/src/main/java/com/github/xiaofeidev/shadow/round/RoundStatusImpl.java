package com.github.xiaofeidev.shadow.round;
...
public class RoundStatusImpl implements RoundStatus {
    ...
    public static final class RoundStatusBuilder {
        //ViewGroup 整体的圆角半径
        private float mRadius;
        private float mTopLeftRadius = INVALID_VALUE;
        private float mTopRightRadius = INVALID_VALUE;
        private float mBottomLeftRadius = INVALID_VALUE;
        private float mBottomRightRadius = INVALID_VALUE;
